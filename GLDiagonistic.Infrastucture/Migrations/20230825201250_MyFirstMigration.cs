...
namespace GLDiagonistic.Infrastucture.Migrations
{
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DoctorsFee = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    Email = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    SpecialistOn = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Appointments_Investigations_InvestigationId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_InvestigationResults_Appointments_AppointmentId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Appointments_InvestigationId",
                table: "Appointments",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_InvestigationResults_AppointmentId",
